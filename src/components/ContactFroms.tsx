...
export function ContactForm({subject, title, hasSubTitle, subTitle}: ContactFormProps) {
    ...
    return (
        <Card
            className="max-w-full md:min-w-[400px] md:max-w-md mx-4 md:mx-auto bg-white shadow-lg rounded-lg overflow-hidden bg-gradient-to-r from-pink-200 via-purple-200 to-blue-200">
            <LoadingShimmerComp loading={isLoading} loader="spinner">
                <div className="sm:flex sm:items-center px-6 py-4">
                    <h2 className="text-lg font-semibold text-gray-900">{title}</h2>
                    {hasSubTitle && <p className="mt-2 text-gray-600 sm:mt-0 sm:ml-4">{subTitle}</p>}
                </div>
                <form onSubmit={(e) => {
                    handleSubmit(e)
                }}>
